# personal-website-solution - Work Plan
...
- Evidence: .omo/evidence/task-<N>-personal-website-solution.<ext>
...
- [ ] 1. <title>
  ...
  QA scenarios (name the exact tool + invocation): happy + failure, Evidence .omo/evidence/task-1-personal-website-solution.<ext>
